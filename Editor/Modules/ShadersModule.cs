...
#endif
    {
        static readonly IssueLayout k_ShaderLayout = new IssueLayout
        {
            ...
            properties = new[]
            {
                ...
                new PropertyDefinition { type = PropertyTypeUtil.FromCustom(ShaderProperty.NumVariants), format = PropertyFormat.Integer, name = "Num Variants", longName = "Number of potential shader variants for a single stage (e.g. fragment)" },
                new PropertyDefinition { type = PropertyTypeUtil.FromCustom(ShaderProperty.NumBuiltVariants), format = PropertyFormat.Integer, name = "Built Variants", longName = "Number of fragment shader variants in the build" },
