...
#endif
    {
        static readonly IssueLayout k_ShaderLayout = new IssueLayout
        {
            ...
            properties = new[]
            {
                ...
                new PropertyDefinition { type = PropertyTypeUtil.FromCustom(ShaderProperty.NumBuiltVariants), format = PropertyFormat.Integer, name = "Built Variants", longName = "Number of fragment shader variants in the build for a single stage (e.g. fragment), per shader platform (e.g. GLES30)" },
