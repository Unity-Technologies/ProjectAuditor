...
* Fixed code analysis when Compilation Mode is set to Editor Play Mode in the config
* ProjectAuditorSettings and (most of) ProjectAuditorConfig are public again, allowing them to be edited in the Inspector
